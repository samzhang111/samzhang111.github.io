...
the popular Delaunay/Voronoi javascript libraries on github supporting line segments at the moment, but a quick workaround could be to just add more points for each element based off its size. There is some support [in Python](https://github.com/aewallin/openvoronoi), though. 
